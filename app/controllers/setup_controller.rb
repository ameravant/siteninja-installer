class SetupController < ApplicationController
  ...
  def index
    ...
    if ActiveRecord::Base.connection.tables.include?("settings")
      ...
      if !@cms_config['site_settings']['feature_box_border'] or @cms_config['site_settings']['feature_box_border'] == ""
        @cms_config['site_settings']['feature_box_border'] = "4px solid #e6e6e6"
      end
      if !@cms_config['site_settings']['feature_box_background_color'] or @cms_config['site_settings']['feature_box_background_color'] == ""
